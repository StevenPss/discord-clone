        ...
        <div class="bg-gray-700 h-24 flex items-center mx-3">
            ...
            <div class="flex-1">
              <form action="" method="post">
                <input type="text" class="w-full text-sm h-10 px-2 py-2 bg-gray-800 text-gray-200 focus:outline-none" disabled={!channelId} value={input} onChange={(e) => setInput(e.target.value)} placeholder={`Message #${channelName}`}/>
